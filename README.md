...
Automação do macOS + computer-use + metering de uso — servidor MCP aberto (open-core). **v0.32.0: 109 tools**, console web e medição por chave. Sem o teto de 100 chamadas/dia do Macuse, com quantos agentes quiser ao mesmo tempo.
